...
RUN npm ci
COPY web/ .
# The same-origin demo needs a write token baked into the bundle so create and transfer work. This is a
# demo token, not protection. See ADR-0015 and docs/correctness.md.
ARG VITE_API_TOKEN
